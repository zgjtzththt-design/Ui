...
const allAnimUnlock = {
  anim1: {
    ...
    box10: "translateX(-50px) translateY(60px) scale(2.3)",
    box11: "translateX(50px) translateY(60px) scale(2.3)",
    box12: "translateX(100px) translateY(60px) scale(2.3)",
    box13: "translateX(-100px) translateY(20px) scale(2.3)",
    box14: "translateX(-50px) translateY(20px) scale(2.3)",
    box15: "translateX(50px) translateY(20px) scale(2.3)",
    box16: "translateX(100px) translateY(20px) scale(2.3)",
    box17: "translateX(-100px) translateY(-20px) scale(2.3)",
    box18: "translateX(-50px) translateY(-20px) scale(2.3)",
    box19: "translateX(50px) translateY(-20px) scale(2.3)",
    box20: "translateX(100px) translateY(-20px) scale(2.3)",
    box21: "translateX(-100px) translateY(-60px) scale(2.3)",
    box22: "translateX(-50px) translateY(-60px) scale(2.3)",
    box23: "translateX(50px) translateY(-60px) scale(2.3)",
  ...
  anim2: {
    ...
    box11: "translateX(0px) translateY(0px) scale(0.2)",
    box12: "translateX(0px) translateY(0px) scale(0.2)",
    box13: "translateX(0px) translateY(0px) scale(0.2)",
    box14: "translateX(0px) translateY(0px) scale(0.2)",
    box15: "translateX(0px) translateY(0px) scale(0.2)",
    box16: "translateX(0px) translateY(0px) scale(0.2)",
    box17: "translateX(0px) translateY(0px) scale(0.2)",
    box18: "translateX(0px) translateY(0px) scale(0.2)",
    box19: "translateX(0px) translateY(0px) scale(0.2)",
    box20: "translateX(0px) translateY(0px) scale(0.2)",
    box21: "translateX(0px) translateY(0px) scale(0.2)",
    box22: "translateX(0px) translateY(0px) scale(0.2)",
    box23: "translateX(0px) translateY(0px) scale(0.2)",
  ...
  anim3: {
    ...
    box10: "translateX(14px) translateY(-60px) scale(0.38)",
    box11: "translateX(-14px) translateY(-60px) scale(0.38)",
    box12: "translateX(-42px) translateY(-60px) scale(0.38)",
    box13: "translateX(42px) translateY(-35px) scale(0.38)",
    box14: "translateX(14px) translateY(-35px) scale(0.38)",
    box15: "translateX(-14px) translateY(-35px) scale(0.38)",
    box16: "translateX(-42px) translateY(-35px) scale(0.38)",
    box17: "translateX(42px) translateY(-50px) scale(0.38)",
    box18: "translateX(21px) translateY(-50px) scale(0.38)",
    box19: "translateX(-21px) translateY(-50px) scale(0.38)",
    box20: "translateX(-42px) translateY(-50px) scale(0.38)",
    box21: "translateX(42px) translateY(-65px) scale(0.38)",
    box22: "translateX(21px) translateY(-65px) scale(0.38)",
    box23: "translateX(-21px) translateY(-65px) scale(0.38)",
  ...
  anim5: {
    ...
    box13: "translateY(100px)",
    box14: "translateY(100px)",
    box15: "translateY(100px)",
    box16: "translateY(100px)",
    box17: "translateY(100px)",
    box18: "translateY(100px)",
    box19: "translateY(100px)",
    box20: "translateY(100px)",
    box21: "translateY(100px)",
    box22: "translateY(100px)",
    box23: "translateY(100px)",
